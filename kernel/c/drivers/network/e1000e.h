...
#define E1000E_REG_EEPROM    0x0014
...
#define E1000E_RCTL_LBM_NONE (0 << 6)
#define E1000E_RCTL_RDMTS_HALF (0 << 8)
...
#define E1000E_TCTL_CT       (0xF << 4)   // Collision Threshold
#define E1000E_TCTL_COLD     (0x3F << 12) // Collision Distance
...
void e1000e_init(uintptr_t base_addr);
